...
### remote
- dry run
  - `deno run --allow-env --allow-read --allow-write https://deno.land/x/module_specifier_resolver@v1.0.17/bin.ts -b=./src -c=./tsconfig.json -d`
- transform
  - `deno run --allow-env --allow-read --allow-write https://deno.land/x/module_specifier_resolver@v1.0.17/bin.ts -b=./src -c=./tsconfig.json -r`
### local
- `deno task run-dry`
- `deno task run`
